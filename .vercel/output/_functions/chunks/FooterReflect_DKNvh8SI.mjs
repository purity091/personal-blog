import { e as createAstro, f as createComponent, r as renderTemplate, n as renderSlot, l as renderHead, h as addAttribute } from './astro/server_Ce2yBXnB.mjs';
import 'piccolore';
import 'clsx';
/* empty css                          */
...
const FooterReflect = () => {
  ...
  const socialLinks = [
    ...
    ] }), href: "https://youtube.com/@MohLahlah", label: "Youtube", color: "hover:text-red-500" },
    { icon: /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    ] }), href: "https://linkedin.com/in/MohLahlah", label: "Linkedin", color: "hover:text-blue-600" },
    { icon: /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    ] }), href: "https://github.com/MohLahlah", label: "Github", color: "hover:text-gray-400" }
  ];
  const quickLinks = [
...
export { $$BaseLayout as $, FooterReflect as F, Navbar as N };

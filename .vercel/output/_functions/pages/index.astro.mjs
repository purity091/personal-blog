...
import { useReducedMotion, useSpring, motion, useTransform, useMotionValue, animate } from 'framer-motion';
...
import { c as client, f as featuredPostsQuery } from '../chunks/sanity_CwywpYO3.mjs';
...
const HeroVisualDecorations = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none select-none", children: [
    ...
    NEURAL_LINES.map((line, i) => /* @__PURE__ */ jsx(
      motion.div,
      {
...
const NeuralMesh = () => /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 -z-20 pointer-events-none", children: [
  ...
  /* @__PURE__ */ jsxs("svg", { className: "w-full h-full opacity-[0.1] dark:opacity-30", "aria-hidden": "true", children: [
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        !isMobile && !shouldReduceMotion && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            motion.div,
            {
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-6 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-[var(--accent-purple)]/10 border border-[var(--accent-purple)]/20 text-[var(--accent-purple)] font-bold text-sm md:text-base shadow-sm", children: [
                /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: "👋" }),
                " أهلاً، أنا محمد لحلح"
              ] }),
              /* @__PURE__ */ jsxs("h1", { className: "text-2xl md:text-6xl lg:text-7xl font-black mb-4 md:mb-6 hero-gradient leading-[1.1] tracking-tighter", children: [
                "أساعدك على فهم الذكاء الاصطناعي ",
                /* @__PURE__ */ jsx("br", { className: "hidden md:block" }),
                " لاستكشاف آفاق المستقبل."
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-base md:text-xl text-[var(--text-secondary)] max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed font-medium", children: "أنا مهندس تقني وصانع محتوى. أشارك رحلتي في تفكيك الخوارزميات المعقدة، وأحوّلها إلى شروحات مرئية بسيطة تساعدك على تعلم التكنولوجيا، وتطبيقها في حياتك المهنية لبناء مشاريع حقيقية." }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 mb-16 md:mb-24", children: [
                /* @__PURE__ */ jsxs(
                  motion.a,
                  {
                    href: "/#deep-learning",
                    ...
                    children: [
                      ...
                      "ابدأ رحلة التعلم",
                      /* @__PURE__ */ jsx(ArrowUpRight, { size: 20, className: "md:w-6 md:h-6" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs("a", { href: "/#book", className: "w-full sm:w-auto group flex items-center justify-center gap-3 md:gap-5 text-[var(--text-primary)] hover:text-[var(--accent-purple)] transition-all py-4 md:py-5 px-8 md:px-10 border border-[var(--border-medium)] hover:border-[var(--accent-purple)] rounded-[2rem] bg-[var(--card-bg)] shadow-md hover:shadow-xl text-base md:text-lg", "aria-label": "استكشف كتاب عقل الآلة", children: [
                  /* @__PURE__ */ jsx(Book, { size: 20, className: "md:w-6 md:h-6 group-hover:rotate-12 transition-transform" }),
...
const MyBookSlider = () => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "book", className: "py-16 md:py-32 px-4 md:px-6 relative overflow-hidden bg-[var(--bg-primary)] transition-colors duration-300", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center md:items-end justify-between gap-4 mb-8 md:mb-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center md:text-right", children: [
        ...
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl md:text-5xl font-bold text-[var(--text-primary)] leading-tight", children: [
          "اقرأ المستقبل، ",
    ...
    /* @__PURE__ */ jsx("div", { ref: containerRef, className: "relative overflow-hidden md:overflow-visible", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        style: { x },
        drag: "x",
        ...
        children: books.map((book, i) => {
          ...
          return /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "relative perspective-1000 shrink-0 w-28 md:w-48", children: /* @__PURE__ */ jsxs("div", { className: "aspect-[3/4] rounded-r-lg shadow-2xl border-y border-r border-white/10 relative overflow-hidden", children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: book.image,
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-center w-full", children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-sm md:text-lg font-bold mb-2 text-[var(--text-primary)] leading-snug", children: book.title }),
                  ...
                  /* @__PURE__ */ jsx("div", { className: "space-y-1.5 mb-5", children: book.features.map((feature, fi) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-1.5 text-[9px] md:text-[10px] text-[var(--text-muted)]", children: [
                    /* @__PURE__ */ jsx(CheckCircle2, { size: 10, className: "text-[var(--accent-purple)] shrink-0" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center gap-2 mt-6 md:mt-8", children: books.map((_, i) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => goTo(i),
        className: `rounded-full transition-all duration-300 ${i === index ? "w-6 h-2 bg-[var(--accent-purple)]" : "w-2 h-2 bg-[var(--text-muted)]/30 hover:bg-[var(--text-muted)]/50"}`,
        "aria-label": `الانتقال للكتاب ${i + 1}`
      },
      i
    )) }),
    /* @__PURE__ */ jsx("p", { className: "text-center text-[var(--text-muted)] text-[9px] md:hidden mt-3", children: "← اسحب للتصفح →" })
  ] }) });
};
...
const LLMEcosystem = () => {
  ...
  const items = [
    { icon: /* @__PURE__ */ jsx(MessageSquare, { size: isMobile ? 14 : 18 }), label: "أتمتة المحتوى" },
    { icon: /* @__PURE__ */ jsx(Shield, { size: isMobile ? 14 : 18 }), label: "الامتثال" },
    { icon: /* @__PURE__ */ jsx(BarChart, { size: isMobile ? 14 : 18 }), label: "المخاطر" },
    { icon: /* @__PURE__ */ jsx(Users, { size: isMobile ? 14 : 18 }), label: "المواهب" },
    { icon: /* @__PURE__ */ jsx(Globe, { size: isMobile ? 14 : 18 }), label: "الإمداد" },
    { icon: /* @__PURE__ */ jsx(Zap, { size: isMobile ? 14 : 18 }), label: "أتمتة العمل" }
  ];
  return /* @__PURE__ */ jsxs("section", { id: "ecosystem", className: "py-16 md:py-32 px-4 md:px-6 bg-gradient-to-b from-[var(--bg-primary)] to-[var(--bg-tertiary)] overflow-hidden transition-colors duration-300", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto text-center mb-12 md:mb-20", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-5xl font-bold mb-3 md:mb-4 text-[var(--text-primary)]", children: "تطبيقات الذكاء العملي" }),
    ...
    /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "max-w-5xl mx-auto relative flex items-center justify-center", style: { minHeight: isMobile ? 350 : 500 }, children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 md:w-16 md:h-16 bg-[var(--accent-blue)] rounded-full flex items-center justify-center mb-1 md:mb-2 shadow-[0_0_20px_rgba(59,130,246,0.3)] text-white", children: /* @__PURE__ */ jsx(Workflow, { size: isMobile ? 18 : 28 }) }),
            /* @__PURE__ */ jsx("span", { className: "text-[8px] md:text-[10px] font-bold text-[var(--text-primary)] uppercase tracking-tighter", children: "تطبيقات LLM" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: items.map((item, i) => {
        ...
        return /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "text-[var(--accent-blue)] shrink-0", children: item.icon }),
              /* @__PURE__ */ jsx("span", { className: "text-[8px] md:text-[10px] font-bold text-[var(--text-primary)] whitespace-nowrap truncate", children: item.label })
            ]
          },
          i
        );
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "\u0645\u062D\u0645\u062F \u0644\u062D\u0644\u062D | \u062E\u0628\u064A\u0631 \u0627\u0644\u0630\u0643\u0627\u0621 \u0627\u0644\u0627\u0635\u0637\u0646\u0627\u0639\u064A - \u062A\u0639\u0644\u0645 AI \u0648\u0627\u0644\u0634\u0628\u0643\u0627\u062A \u0627\u0644\u0639\u0635\u0628\u064A\u0629" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", Navbar, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/Navbar.tsx", "client:component-export": "default" })} ${maybeRenderHead()}<main> ${renderComponent($$result2, "Hero", Hero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/Hero.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "FeaturedArticles", FeaturedArticles, { "client:visible": true, "articles": featuredPosts, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/FeaturedArticles.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "DeepLearningTensors", DeepLearningTensors, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/DeepLearningTensors.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "AITermsExplorer", AITermsExplorer, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/AITermsExplorer.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "MyBookSlider", MyBookSlider, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/MyBookSlider.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "SocialBentoGrid", SocialBentoGrid, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/SocialBentoGrid.tsx", "client:component-export": "default" })} ${renderComponent($$result2, "LLMEcosystem", LLMEcosystem, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/LLMEcosystem.tsx", "client:component-export": "default" })} </main> ${renderComponent($$result2, "FooterReflect", FooterReflect, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/xampp/htdocs/personal brand/src/components/FooterReflect.tsx", "client:component-export": "default" })} ` })}`;

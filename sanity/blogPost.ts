    ...
    },
    {
      ...
      options: {
        list: [
          ...
          { title: ' الرؤية الحاسوبية', value: 'الرؤية الحاسوبية' },
          { title: ' الشبكات العصبية', value: 'الشبكات العصبية' },
          { title: ' Transformers', value: 'Transformers' },
          { title: ' ChatGPT', value: 'ChatGPT' },
          { title: ' Python', value: 'Python' },
          { title: ' أدوات وتقنيات', value: 'أدوات وتقنيات' },
          { title: ' مشاريع عملية', value: 'مشاريع عملية' },
          { title: ' سلوك المستهلك', value: 'سلوك المستهلك' },
          { title: ' التسويق', value: 'التسويق' },
          { title: ' DevOps', value: 'DevOps' },
          { title: ' هندسة البرمجيات', value: 'هندسة البرمجيات' },
          { title: ' تطوير الواجهات الأمامية', value: 'تطوير الواجهات الأمامية' },
          { title: ' البرمجيات مفتوحة المصدر', value: 'البرمجيات مفتوحة المصدر' },
          { title: ' النماذج اللغوية الكبيرة LLMs', value: 'النماذج اللغوية الكبيرة LLMs' },
          { title: ' أبحاث السوق', value: 'أبحاث السوق' },
          { title: ' إدارة العملاء CRM', value: 'إدارة العملاء CRM' },

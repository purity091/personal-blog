...
const NewsletterReflect = () => (
  <section className="py-16 md:py-32 px-6 relative overflow-hidden bg-[var(--bg-primary)] transition-colors duration-500">
    ...
    <div className="max-w-5xl mx-auto">
      ...
      >
        <div className="absolute -inset-1 bg-gradient-to-r from-[var(--accent-purple)] to-[var(--accent-blue)] rounded-[2rem] md:rounded-[3rem] blur opacity-10 group-hover:opacity-20 transition duration-1000 group-hover:duration-200" />
        
        <div className="relative glass-card p-8 md:p-16 rounded-[2rem] md:rounded-[3rem] text-center z-10 overflow-hidden border-[var(--border-subtle)]/50 shadow-2xl">
          ...
          <div className="flex flex-col items-center relative z-20">
            <motion.div 
              ...
              className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-[var(--accent-purple)] to-[var(--accent-blue)] rounded-xl md:rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg shadow-purple-500/20"
            >
              <Mail size={24} />
            </motion.div>

            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--accent-purple)]/10 text-[var(--accent-purple)] text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] mb-4 border border-[var(--accent-purple)]/20 shadow-sm">
               <Users size={12} /> أكثر من 15,000 مشترك
            </div>

            <h2 className="text-3xl md:text-5xl font-black mb-4 hero-gradient tracking-tighter leading-[1.1]">
              كن جزءاً من المستقبل
            </h2>
            
            <p className="text-[var(--text-secondary)] text-xs md:text-lg mb-8 max-w-xl mx-auto leading-relaxed font-medium">

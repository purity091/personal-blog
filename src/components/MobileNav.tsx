            ...
            >
              <div className={`p-1 rounded-lg transition-colors ${
                (item as any).isWhatsApp 
                  ...
                  : 'group-hover:bg-[var(--accent-purple)]/10'
              }`}>
                {item.icon}
              </div>
              ...
              <motion.div 
                className={`absolute -bottom-1 w-1 h-1 rounded-full opacity-0 group-hover:opacity-100 ${
                  (item as any).isWhatsApp ? 'bg-[#25D366]' : 'bg-[var(--accent-purple)]'
                }`}
                layoutId="activeTab"
              />
            </a>

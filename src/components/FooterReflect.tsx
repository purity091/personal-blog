...
const FooterReflect = () => {
  ...
  const socialLinks = [
    { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" /></svg>, href: "https://x.com/lahlahai", label: "Twitter", color: "hover:text-blue-400" },
    { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m22 8-6 4 6 4V8Z" /><rect width="14" height="12" x="2" y="6" rx="2" ry="2" /></svg>, href: "https://youtube.com/@lahlah-ai", label: "Youtube", color: "hover:text-red-500" },
    { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>, href: "https://linkedin.com/in/mohamed-lahlah", label: "Linkedin", color: "hover:text-blue-600" },
    { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" /><path d="M9 18c-4.51 2-5-2-7-2" /></svg>, href: "https://github.com/lahlahai", label: "Github", color: "hover:text-gray-400" },
    {
      ...
      href: "https://facebook.com/lahlahai",
      label: "Facebook",
      ...
      <div className="max-w-6xl mx-auto  relative z-10">
        ...
        <div className="footer-main-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
          ...
          <div className="footer-column-contact lg:col-span-4">
            ...
            <a
              href="https://wa.me/963936638280"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-[var(--bg-tertiary)] border border-[var(--border-subtle)] p-4 rounded-2xl group hover:border-[var(--accent-purple)]/50 transition-all"
            >
              <div className="w-10 h-10 rounded-full bg-[var(--accent-purple)]/10 flex items-center justify-center text-[var(--accent-purple)] group-hover:bg-[var(--accent-purple)] group-hover:text-white transition-all">
                {/* استبدلت أيقونة Mail بأيقونة MessageCircle إذا كنت تستخدم Lucide-react */}
                <MessageCircle size={18} />
              </div>
              <div>
                <div className="text-[10px] font-black text-[var(--text-muted)] uppercase">راسلني عبر</div>
                <div className="text-sm font-bold text-[var(--text-primary)]">الواتساب</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer-copyright-bar pt-8 border-t border-[var(--border-subtle)] flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-[var(--text-muted)] text-[10px] md:text-xs">
            © {currentYear} مرخص بموجب رخصة المشاع الإبداعي (CC BY-NC-SA 4.0) ما لم يُذكر خلاف ذلك.
          </div>

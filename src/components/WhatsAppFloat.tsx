...
const WhatsAppFloat = () => {
  return (
    <motion.div
      ...
      className="fixed bottom-24 left-6 z-[9999] hidden lg:block"
    >
      <a
        href="https://wa.me/963936638280"
        target="_blank"
        rel="noopener noreferrer"
        className="group relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-all duration-300"
        aria-label="Contact on WhatsApp"
      >
        {/* Glow Effect */}
        <div className="absolute inset-0 rounded-full bg-[#25D366] blur-xl opacity-20 group-hover:opacity-40 transition-opacity animate-pulse" />

        {/* WhatsApp Icon */}
        <div className="relative z-10 text-white w-7 mb-[7px] h-7">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="mb-[6px] " fill="currentColor">
